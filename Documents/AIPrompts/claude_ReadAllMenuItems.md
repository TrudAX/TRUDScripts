...
then analyse all <AxMenuElement> tags and extract the following:
...
e.g. directory name may be 

K:\AosService\PackagesLocalDirectory\ApplicationSuite\Foundation\AxMenuExtension with .xml files 
...
AxMenuItemAction, AxMenuItemDisplay, AxMenuItemOutput. (e.g. 

K:\AosService\PackagesLocalDirectory\ApplicationSuite\Foundation\AxMenuItemAction)
...
from this extract the following info:
